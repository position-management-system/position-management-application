...
export const TradeDeleteDialog = (props: ITradeDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="positionApp.trade.delete.question">
        <Translate contentKey="positionApp.trade.delete.question" interpolate={{ id: tradeEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-trade" color="danger" onClick={confirmDelete}>
