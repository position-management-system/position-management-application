...
@RestController
@ConditionalOnProperty("kafka.rest.controller.enabled")
@RequestMapping("/api/position-kafka")
public class PositionKafkaResource {

    private final Logger log = LoggerFactory.getLogger(PositionKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public PositionKafkaResource(KafkaProperties kafkaProperties) {
